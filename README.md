...
**1.Error al conectarse al contenedor de Docker**: 

Docker usa IPV6 por lo que si usamos localhost docker no se conectará.
...
**2.Desconocimiento de donde guardar la llave generada**: 

La terminal de la máquina anfitriona al introducir el comando te pide que selecciones un archivo donde guardarla.  
...
**3.Error al conectarse desde el Escritorio Remoto con localhost:3389**: 

Nos dice que  hay otra conexión activa.  
